...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://dev-api.payfactory.app";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("ApiKey", new ApiKeyAuth("header", "pf-api-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://dev-api.payfactory.app)
